...
public class ServerConnectionHandler implements Runnable
{
    ...
    private static String[] cmdSequenceList;// isRcptReady + isFromReady + dataMap.toString()
    ...
    private void Server_SMTP_Handler(socketManager sm, String clientMSG) 
    {
        ...
        try{
            ...
            ////////////////////////////////////////////////////////////////////
                ...
                {   
                    String key = keygenerator();
                    sResponceToClient = AES.encrypt("214 RCPT command can be use one or multiple times to add one or many recipients" + CRLF,key);
                }
                else if (clientMSG.toUpperCase().contains("HELP DATA")&& GO_ON_CHECKS)
                {   
                    String key = keygenerator();
                    sResponceToClient = AES.encrypt("214 DATA command is use to input your actual mail data" + CRLF,key);
                }
